...
export default function GuesthouseDirectory() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-frogs-dark py-24 lg:py-32 z-[70]"
    >
      ...
      <div className="px-6 lg:px-16 max-w-7xl mx-auto relative">
        ...
        <div ref={headerRef} className="text-center mb-16 lg:mb-24">
          <span className="label-micro text-frogs-gold mb-6 block">{t("INFORMATION", "ΠΛΗΡΟΦΟΡΙΕΣ")}</span>
          <h2 className="font-display text-5xl lg:text-8xl text-frogs-text-light mb-4 perspective-1000">
            {splitText(t('GUESTHOUSE', 'ΟΔΗΓΟΣ'))}
          </h2>
          <h2 className="font-display text-5xl lg:text-8xl text-frogs-gold perspective-1000">
            {splitText(t('DIRECTORY', 'ΞΕΝΩΝΑ'))}
          </h2>
        </div>

        {/* Introduction */}
        <div ref={introRef} className="max-w-3xl mx-auto text-center mb-20">
          ...
          <p className="font-heading text-lg text-frogs-gold">
            ...
            >
              <div className="flex items-start gap-5">
                <div className="w-12 h-12 rounded-xl bg-frogs-gold/10 flex items-center justify-center flex-shrink-0 group-hover:bg-frogs-gold/20 transition-colors duration-300">
                  <item.icon className="w-6 h-6 text-frogs-gold" />
                </div>
        ...
        <div
          ref={emergencyRef}
          className="mt-16 lg:mt-24 p-8 lg:p-12 rounded-2xl bg-gradient-to-br from-frogs-gold/10 to-frogs-gold/5 border border-frogs-gold/20"
        >
